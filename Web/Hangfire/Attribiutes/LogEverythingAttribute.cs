...
public class LogEverythingAttributeLegacy : JobFilterAttribute, IClientFilter, IServerFilter, IElectStateFilter, IApplyStateFilter
{
    public LogEverythingAttributeLegacy()
    {
    }
